...
class UserTest < ActiveSupport::TestCase
	def setup
		@user = User.new(name: "The Dude", email: "thedude@gmail.com", password: "foobar", password_confirmation: "foobar")
	end
  ...
  test "should follow and unfollow a user" do
    michael = users(:test_user)
    archer  = users(:test_user2)
